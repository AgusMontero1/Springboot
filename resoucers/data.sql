...
INSERT INTO entregable_3.client (name, last_name, doc_number)
VALUES
...
INSERT INTO entregable_3.invoice (client_id, created_at, total)
VALUES
    (1, '2023-09-20', 100.50),
    (2, '2023-09-21', 75.20),
    (3, '2023-09-22', 200.75);
...
INSERT INTO entregable_3.product (description, code, stock, price)
VALUES
...
INSERT INTO entregable_3.invoice_detail (invoice_id, amount, product_id, price)
VALUES
    (1, 2, 1, 25.99),
    (1, 3, 2, 10.50),
    (2, 1, 3, 5.75);